...
public class VoitureApplication {
    ...
    CommandLineRunner initialiserBaseH2(VoitureRepository voitureRepository) {
        return args -> {
            voitureRepository.save(new Voiture(null, "Marque 1", "MATRICULE 1", "Model 1", 1L, null));
            voitureRepository.save(new Voiture(null, "Marque 2", "MATRICULE 2", "Model 2", 1L, null));
            voitureRepository.save(new Voiture(null, "Marque 3", "MATRICULE 3", "Model 3", 1L, null));
        };
    }
    */
    @Bean
